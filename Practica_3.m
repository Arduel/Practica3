...
% Last Modified by GUIDE v2.5 27-May-2021 23:59:16
...
% varargin   command line arguments to Practica_3 (see VARARGIN)
...
% UIWAIT makes Practica_3 wait for user response (see UIRESUME)
...
% hObject    handle to ydiv (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ydiv as text
%        str2double(get(hObject,'String')) returns contents of ydiv as a double
...
% hObject    handle to xdiv (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xdiv as text
%        str2double(get(hObject,'String')) returns contents of xdiv as a double
